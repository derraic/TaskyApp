                ...
                LazyColumn(modifier = Modifier
                    ...
                    this.item {
                        ...
                        Row(modifier = Modifier
                            ...
                            Column() {
                                Box (modifier = Modifier
                                    ...
                                    Image(modifier = Modifier.clickable { viewModel.onEvent(EventEvent.AdjustNotificationClick) }
                        ...
                        Row(modifier = Modifier.fillMaxWidth(),horizontalArrangement = Arrangement.Center) {
                            Text(
                                modifier = Modifier.clickable { viewModel.onEvent(EventEvent.LeaveOrJoinEventClick) },
